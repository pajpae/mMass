    ...
    def makeToolbar(self):
        ...
        if wx.Platform != "__WXMAC__":
            ...
            self.toolbar.AddTool(
                ...
                longHelp="Save current document",
            )
            self.toolbar.AddTool(
        ...
        self.toolbar.AddTool(
            ...
            longHelp="Mass spectrum processing",
        )
        self.toolbar.AddTool(
            ID_toolsCalibration,
            "Calibration",
            ...
            longHelp="Mass spectrum calibration",
        )
        ...
        self.toolbar.AddTool(
            ...
            longHelp="Sequence editor and tool",
        )
        ...
        self.toolbar.AddTool(
            ...
            longHelp="Periodic table of elements",
        )
        self.toolbar.AddTool(
            ...
            longHelp="Calculate ion series and isotopic pattern",
        )
        self.toolbar.AddTool(
            ...
            longHelp="Generate molecular formulae for specified mass",
        )
        self.toolbar.AddTool(
            ...
            longHelp="Show various mass defect plots for current peak list",
        )
        ...
        self.toolbar.AddTool(
            ...
            longHelp="Filter spectrum contaminants",
        )
        self.toolbar.AddTool(
        ...
        self.toolbar.AddTool(
            ...
            longHelp="Calculate peak differences",
        )
        self.toolbar.AddTool(
            ID_toolsComparePeaklists,
            "Compare",
            ...
            longHelp="Compare multiple peaklists",
        )
        self.toolbar.AddTool(
            ID_toolsSpectrumGenerator,
            "Generator",
            ...
            longHelp="Generate mass spectrum from current peak list",
        )
        self.toolbar.AddTool(
            ID_toolsEnvelopeFit,
            "Envelope Fit",
            ...
            longHelp="Calculate atom exchange from peak envelope",
        )
        ...
        self.toolbar.AddTool(
            ...
            longHelp="Send data to Mascot server",
        )
        self.toolbar.AddTool(
            ID_toolsProfound,
            "ProFound",
            ...
            longHelp="Send data to ProFound server",
        )
        ...
        self.toolbar.AddTool(
            ...
            longHelp="Show document information and notes",
        )
        self.toolbar.AddTool(
            ...
            longHelp="Make analysis report for current document",
        )
        self.toolbar.AddTool(
            ...
            longHelp="Export spectrum, peaklist or image",
        )
    ...
    def onHelpUserGuide(self, evt):
        ...
        try:
            ...
            dlg = mwx.dlgMessage(
                ...
                message="Please make sure that you have any application associated\nwith a PDF format.",
            )
            dlg.ShowModal()
            dlg.Destroy()
            return
